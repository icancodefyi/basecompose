    ...
    <section className="relative w-full px-4 sm:px-6 lg:px-8 border-t border-gray-800/50">
      <div className="w-full max-w-7xl mx-auto py-24">
        ...
        <div className="mb-20">
          ...
          <p className="text-base text-gray-500 font-light max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {useCases.map((useCase, idx) => (
            <div
              key={idx}
              className="flex gap-5 p-6 rounded-lg border border-gray-800/50 hover:border-emerald-500/30 hover:bg-emerald-950/5 transition-all duration-300 group"
            >
              <div className="flex-shrink-0 text-3xl">{useCase.icon}</div>
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-normal text-white mb-2 group-hover:text-emerald-300 transition-colors">
                  {useCase.title}
                </h3>
