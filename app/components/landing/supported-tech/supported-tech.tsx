              ...
              <div className="flex flex-col gap-3">
                {tech.items.map((item, itemIdx) => {
                  ...
                  return (
                    <div
                      key={itemIdx}
                      className="group relative overflow-hidden rounded border border-gray-800/50 hover:border-emerald-500/40 transition-all duration-300 p-4 bg-gradient-to-br from-gray-900/20 to-black/40 hover:from-gray-900/40 hover:to-emerald-950/20"
                    >
                      ...
                      <div className="relative z-10 flex items-center gap-3">
                        <Icon className="w-4 h-4 flex-shrink-0 text-gray-500 group-hover:text-emerald-400 transition-colors" />
                        <span className="text-sm text-gray-300 group-hover:text-emerald-300 transition-colors font-medium">
                          {item.name}
                        </span>
                      </div>
