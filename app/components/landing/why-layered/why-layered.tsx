          ...
          {reasons.map((reason, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div className="text-2xl font-light text-emerald-400/60 group-hover:text-emerald-400 transition-colors mb-3">
                  {reason.icon}
                </div>

                {/* Label */}
                <h3 className="text-sm font-semibold text-white mb-2 group-hover:text-emerald-400 transition-colors">
                  {reason.label}
                </h3>
