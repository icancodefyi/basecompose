    ...
    <section className="relative w-full px-4 sm:px-6 lg:px-8 border-t border-gray-800/50">
      <div className="w-full max-w-7xl mx-auto py-24">
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl font-normal text-white leading-[1.2] mb-6">
            Stop boilerplating. Start shipping.
          </h2>
          
          <p className="text-base text-gray-400 font-light mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            <a
              ...
              className="px-8 py-3 rounded border border-emerald-500/60 text-emerald-400 hover:border-emerald-400 hover:bg-emerald-950/30 transition-all text-sm font-medium"
            >
              Explore on GitHub
            </a>
            <a
              href="/chat"
              className="px-8 py-3 rounded bg-emerald-600 text-white hover:bg-emerald-500 transition-colors text-sm font-medium"
            >
              Generate Your Setup
            </a>
          </div>
